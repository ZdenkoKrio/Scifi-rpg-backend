...
class Faction(models.Model):
    ...
    capital_system = models.ForeignKey("space.StarSystem", on_delete=models.SET_NULL, null=True, blank=True,
    ...
    controlled_systems = models.ManyToManyField("space.StarSystem", blank=True, related_name="controlled_by")
